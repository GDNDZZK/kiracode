...
export const SettingsFooter = ({ version, className, ...props }: SettingsFooterProps) => (
	<div className={cn("text-vscode-descriptionForeground p-5", className)} {...props}>
		{/* // kilocode_change start - removed Reddit and email links, only keep GitHub */}
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			If you have any questions or feedback, feel free to open an issue at{" "}
			<VSCodeLink href="https://github.com/GDNDZZK/kiracode" style={{ display: "inline" }}>
				github.com/GDNDZZK/kiracode
			</VSCodeLink>
			.
		</p>
		{/* // kilocode_change end */}
		<p className="italic">Kira Code v{version}</p>
