// kilocode_change start - removed X/Discord/Reddit social links and Careers section, updated GitHub link
...
const GitHubLink = ({ children }: { children?: ReactNode }) => (
	<VSCodeLink
		href="https://github.com/GDNDZZK/kiracode"
		onClick={(e) => {
			e.preventDefault()
			vscode.postMessage({ type: "openExternal", url: "https://github.com/GDNDZZK/kiracode" })
		}}>
		{children}
	</VSCodeLink>
)
